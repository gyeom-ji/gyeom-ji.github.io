...
: 간선의 <span style="color:#9fb584">**가중치 합이 최소**</span>인 [신장트리](#그래프-용어)로 MST를 찾는 대표적인 알고리즘은 [`Kruskal`](https://gyeom-ji.github.io/posts/kruskal-algorithm/), [`Prim`](https://gyeom-ji.github.io/posts/prim-algorithm/), `Sollin` 알고리즘이 있다.
