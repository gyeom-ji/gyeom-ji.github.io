...
<br/> 
대표적인 <span style="color:#9fb584">**최소 신장 트리 알고리즘**</span>으로 탐욕적인 방법을 이용해 가중치를 간선에 할당한 그래프의 <span style='background-color:#c8d8b4'>모든 정점을 최소 비용으로 연결</span>하는 최적 해답을 구하는 알고리즘 
